...
class GetHalfCustomerFeat:
    def __init__(self, db=None, loan_id=None):
        self.db = db
        self.loan_id = loan_id

    def get_half_data_feat(self, merchant_code=None):
        # 取得full_link表里的字段
...
if __name__ == '__main__':
    ...
    data = GetHalfCustomerFeat('api_loansuper_x4', 986971).get_half_data_feat(merchant_code='x4_system')
